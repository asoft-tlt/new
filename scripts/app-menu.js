    ...
    switch (page.type) {
      ...
      case 'page':
        ...
        if (page.slides && !page.slider) {
            ...
            onPrev: function(){ if(!this.constant){this.decrease();}else{App.slider.swipePrev();} }
          }, page));
...
/**/
        $(this.slide).on('doubletap', '.page', function(){$(".menu-slide").removeClass("zm");$('.menu-container').toggle()});
        $(document).on('tap', '.clsb', function(){$('.menu-container').hide();$('.portfolio-container').hide()});
        $(document).on('tap', '.bimg', function(){$('.menu-container').hide();$('.portfolio-container').show()});
        $(document).on('tap', '.bsod', function(){$('.menu-container').show();$('.portfolio-container').hide()});
